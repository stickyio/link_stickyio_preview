...
var stubStickyioProductID = sinon.stub();
...
function proxyModel() {
    return {
        mocks: proxyquire('../../cartridges/int_stickyio_sfra/cartridge/models/productLineItem/decorators/index', {
            ...
            '~/cartridge/models/productLineItem/decorators/stickyioProductID': stubStickyioProductID,
        ...
        stubs: {
            ...
            stubStickyioProductID: stubStickyioProductID,
