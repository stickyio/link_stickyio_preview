...
describe('Checkout: Submit Payment', function () {
    this.timeout(5000);

    it('should successfully submit a cart with a subscription product', function () {
        ...
        myRequest.form = {
            pid: config.variantPid1,
            quantity: config.qty1,
            stickyioProductID: config.stickyioProductID1,
            stickyioVariationID: config.stickyioVariationID1,
            stickyioCampaignID: config.stickyioCampaignID1,
            stickyioOfferID: config.stickyioOfferID1,
            stickyioBillingModelID: config.stickyioBillingModelID1,
            stickyioBillingModelDetails: config.stickyioBillingModelDetails1
        };
